...
openssh iwd openresolv wpa_supplicant wireless_tools dialog lvm2 grub efibootmgr \
dosfstools mtools nano zsh os-prober wget curl git apparmor unrar unzip cups vim xsane \
sane-gt68xx-firmware ranger evince w3m xf86-video-intel libva-intel-driver \
